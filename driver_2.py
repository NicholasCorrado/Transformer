...
SP500_CONSTITUENTS_ENERGY = ['APA', 'BKR', 'COP', 'CTRA', 'CVX', 'DVN', 'EOG', 'HAL', 'HES', 'MRO', 'OXY', 'PXD', 'SLB', 'VLO', 'XOM']
...
#     assert (args.sinusoidal or args.learnable)
    ...
    if stock_data_2 is None:
        train_dls, val_dls = batch_data_price_prediction(stock_data_1, vocab_size=args.vocab_size, batch_size=args.batch_size)
    else:
        print('TRANSLATION')
        train_dls, val_dls = batch_data_price_translation(stock_data_1, stock_data_2, vocab_size=args.vocab_size, batch_size=args.batch_size)
